...
export default async function handler(req, res) {
    ...
    const LOGO_URL = 'https://bhusethu.com/images/logo.svg'; // Placeholder: CHANGE THIS
    ...
    try {
        ...
        const transporter = nodemailer.createTransport({
            ...
            auth: {
                user: process.env.SMTP_USER, // Sender Email (e.g., info@bhusethu.com)
...
<h2 style="color:${PRIMARY_COLOR};border-bottom: 2px solid #ddd;padding-bottom:10px;">📬 ${BRAND_NAME} New Inquiry</h2>
...
<div style="max-width:650px;margin:0 auto;background:#ffffff;border-radius:12px;overflow:hidden;
                    font-family:'Poppins', 'Helvetica Neue', Arial, sans-serif;font-size:16px;line-height:1.7;color:#333;box-shadow: 0 6px 15px rgba(0,0,0,0.15);">
                        ...
                        <div style="background-color:${PRIMARY_COLOR}; /* Primary Color background */
...
<h1 style="margin:0.3em 0 0;font-weight:700;font-size:2em; color:#ffffff;">
                                Inquiry <span style="color:${ACCENT_COLOR};">Confirmed!</span>
</h1>
</div>
 
                        <div style="padding:1.8em 2.5em;">
<p style="margin-top:0;">Hello ${name},</p>
<p>Thank you for contacting ${BRAND_NAME}.<br>
                            We have successfully received your message and our dedicated team is reviewing your request.<br>
                            We aim to connect with you within <span style="font-weight: bold; color: ${PRIMARY_COLOR};">2 business days</span>.</p>
 
                            <div style="margin:25px 0;padding:18px;background:#fcfdff;border-left:4px solid ${PRIMARY_COLOR};border-radius:6px;">
<h3 style="margin-top:0;color:${PRIMARY_COLOR};font-size:1.15em;font-weight:600;">Your Inquiry Details:</h3>
...
<a href="${BRAND_WEBSITE}" target="_blank"
                                    style="background:${PRIMARY_COLOR};color:#fff;text-decoration:none;
                                            padding:14px 28px;border-radius:30px;font-weight:bold;display:inline-block;border: 1px solid ${PRIMARY_COLOR}; text-decoration: none; font-size: 1.05em;">
...
<p>Best regards,</p>
<p style="font-size:1.4em;color:${PRIMARY_COLOR};margin:0;font-weight:700;">The ${BRAND_NAME} Team</p>
<p style="font-size:0.95em;color:#555;margin:0;">${BRAND_EMAIL} | ${BRAND_PHONE}</p>
</div>
